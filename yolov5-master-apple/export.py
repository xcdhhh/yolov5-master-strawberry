...
def run(data=ROOT / 'data/data.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'runs/train/exp4/weights/best.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp4/weights/best.pt', help='weights path')
